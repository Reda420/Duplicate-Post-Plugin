<?php
    ...
    class AdminController
    {
        ...
        public function config_page(): void{
            DuplicatePostPlugin::render('config');
            
        }

        public function admin_init(): void
        {
            register_setting('duplicate_post', 'duplicate_post');
            add_settings_section('duplicate_post_main', null, null, 'duplicate_post');
            add_settings_field('redirect_to', 'Rediriger vers apres avoir clique sur "Dupliquer"', [$this, 'redirect_to_render'], 'duplicate_post', 'duplicate_post_main');
        }

        public function redirect_to_render(): void
        {
            $general_options = get_option('duplicate_post', [
                'redirect_to' => 0
            ]);
            ...
            ?>
                <select name="duplicate_post[redirect_to]">
